...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { description: @mentor.description, name: @mentor.name, picture: @mentor.picture, picture: @mentor.picture }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { description: @mentor.description, name: @mentor.name, picture: @mentor.picture, picture: @mentor.picture }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
