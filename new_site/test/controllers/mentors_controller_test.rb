...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { description: @mentor.description, name: @mentor.name, picture: @mentor.picture, skills: @mentor.skills }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { description: @mentor.description, name: @mentor.name, picture: @mentor.picture, skills: @mentor.skills }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
